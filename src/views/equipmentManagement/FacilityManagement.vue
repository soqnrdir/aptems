          ...
          <div class="modal-dialog">
              ...
              <div class="modal-body text-start">
                <form>
                  ...
                  <div class="mb-3">
                      <label for="name-text" class="col-form-label">설비명:</label>
                      <input type="text" class="form-control" v-model="userData.equipmentNm" id="name-text">
                  </div>
                  <div class="mb-3">
                      <label for="company-text" class="col-form-label">설비위치:</label>
...
export default {
  ...
  methods: {
    ...
    clickInsert () {
      ...
      if (this.userData.equipmentNm == null || this.userData.equipmentNm === '') {
        alert('설비명을 입력해주세요.')
        return
      }
