...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h5 class="fw-bold text-start">장비장애 이력</h5>
      <div class="card mt-5">
        <div class="card-body">
          <div class="row">
            <div class="col-2">
              <select class="form-select" id="auth-text">
                ...
                <option value="장비1">장비1</option>
                <option value="장비2">장비2</option>
              </select>
            </div>
            <div class="col-2">
...
const tableColumns = ['일자', '계측기', '장소', '비고']
const tableData = [{
  measureDate: '2021-05-19 12:10:30',
  measureInstrument: '씨그널계측기',
  place: '지하주차장1',
  content: '통신장애'
},
{
